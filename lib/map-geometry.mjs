...
// Only Erangel needs a raster-to-marker calibration. The 9 m residual from
// the measured reference is split across its north and west axes. Other maps
...
export const markerNorthingCorrection = 0.288;
export const markerEastingCorrection = -0.288;
